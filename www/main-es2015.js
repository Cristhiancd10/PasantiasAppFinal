...
module.exports = __webpack_require__(/*! C:\Users\Cristhian\Downloads\ProyectoPasantiasFunciona\src\main.ts */"zUnb");
...
/* harmony import */ var _servicios_storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./servicios/storage.service */ "6k2k");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, router, storage) {
...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | paginas-login-login-module */[__webpack_require__.e("default~paginas-login-login-module~paginas-nuevains-nuevains-module~paginas-visita-visita-module"), __webpack_require__.e("paginas-login-login-module")]).then(__webpack_require__.bind(null, /*! ./paginas/login/login.module */ "Qd+U")).then(m => m.LoginPageModule)
    },
    {
        path: 'instalacion',
        loadChildren: () => __webpack_require__.e(/*! import() | paginas-instalacion-instalacion-module */ "paginas-instalacion-instalacion-module").then(__webpack_require__.bind(null, /*! ./paginas/instalacion/instalacion.module */ "ovvr")).then(m => m.InstalacionPageModule)
    },
    {
        path: 'visita',
        loadChildren: () => Promise.all(/*! import() | paginas-visita-visita-module */[__webpack_require__.e("default~paginas-login-login-module~paginas-nuevains-nuevains-module~paginas-visita-visita-module"), __webpack_require__.e("paginas-visita-visita-module")]).then(__webpack_require__.bind(null, /*! ./paginas/visita/visita.module */ "/YuW")).then(m => m.VisitaPageModule)
    },
    {
        path: 'nuevains',
        loadChildren: () => Promise.all(/*! import() | paginas-nuevains-nuevains-module */[__webpack_require__.e("default~paginas-login-login-module~paginas-nuevains-nuevains-module~paginas-visita-visita-module"), __webpack_require__.e("paginas-nuevains-nuevains-module")]).then(__webpack_require__.bind(null, /*! ./paginas/nuevains/nuevains.module */ "MIyc")).then(m => m.NuevainsPageModule)
    },
    {
        path: 'tab4',
